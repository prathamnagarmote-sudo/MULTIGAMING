            ...
            {isFullscreen && isMobileDevice && (
              <div className="absolute top-0 left-0 right-0 h-[14px] bg-black border-b border-white/[0.05] flex items-center justify-between z-50 select-none">
                <button
                  ...
                  className="flex items-center gap-0.5 h-full px-2.5 rounded-r bg-[#7c3aed] hover:bg-[#6d28d9] active:scale-95 text-white font-sans font-bold text-[7.5px] uppercase tracking-wider transition-all cursor-pointer border-none"
                >
